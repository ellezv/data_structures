...
def test_add_edge_on_empty_graph(empty_graph):
    ...
    assert empty_graph._nodes["n1"] == [("n2", 1)]
...
def test_edges_on_full_graph(full_graph):
    ...
    assert sorted(full_graph.edges()) == [("a", ("b", 1)), ("a", ("c", 1)), ("b", ("c", 1))]
...
def test_del_edge(full_graph):
    ...
    assert full_graph.edges() == [('a', ('b', 1)), ('a', ('c', 1))]
...
def test_neighbors_full_graph(full_graph):
    ...
    assert sorted(full_graph.neighbors("a")) == [("b", 1), ("c", 1)]
